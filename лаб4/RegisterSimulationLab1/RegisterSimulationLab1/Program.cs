...
namespace RegisterSimulationLab1
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine(VerySimplePassGenerator.TrytoPredictThis("ArtemMaksakov", 20));
            Console.WriteLine(VerySimplePassGenerator.GetHash("Username","MySecretWord"));
            Console.WriteLine(VerySimplePassGenerator.GetHash("Username", "MySecretWord"));
            //ServerSimulation.EncryptFile("us.json", "encrypted.txt");
        ...
        public static void DecryptFile(string inputFile, string outputFile)
        {

            {
                ...
                {
                    string password = @"12345678"; // Your Key Here
